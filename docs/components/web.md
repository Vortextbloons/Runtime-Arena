...
**Badge bonuses**
- Badges are awarded via `awardBadges()` (in `cards/badges/awardBadges.ts`) from three definition groups: **V1** (6 core badges), **V1.5** (2 build-time badges), **V2** (1 memory badge).
